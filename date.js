...
*/
    catchError(getDate) {
            if (getDate === undefined || typeof getDate !== "object" || typeof getDate !== "string") {
                return ERROR_OBJECT
            } else {
                return true;
            }
    ...
    format(date, type) {
        ...
        console.log("see if valid", seeIfValid)
...
let get = formatDateTime.formatDateToPost("2222")
console.log("🚀 ~ file: date.js ~ line 529 ~ get", get)
let format = formatDateTime.format("dec 11, 1995", "ll")
console.log("🚀 ~ file: date.js ~ line 531 ~ format", format)
